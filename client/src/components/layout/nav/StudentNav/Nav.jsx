	...
	return (
		<nav className={styles.nav}>
			...
			<div className={styles.nav__buttonContainer}>
				...
				<button type='button' role='button' className={styles.nav__buttonNav} onClick={()=>setNav(!nav)}>
					<span className={styles.nav__span}></span>
                    <span className={styles.nav__span}></span>
                    <span className={styles.nav__span}></span>
				</button>
			</div>
			<ul role='nav' className={nav ? styles.nav__list : styles.nav__listHidden}>
				<li>
				...
				<li>
					<button type='button' role='button' className={styles.nav__buttonLogOut}>
